...
export const RPC_ENDPOINT = import.meta.env.VITE_RPC_ENDPOINT ?? 'https://mainnet.helius-rpc.com/?api-key=942d9ff6-1275-4a10-ad62-964842238c5c'

// Solana address that will receive fees when somebody plays on this platform
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  '6Vm1eQrFoJhwrakn6b3n1qCQBhkYQCxvxFikJooJeDup',
)
...
export const TOKEN_METADATA: (Partial<TokenMeta> & {mint: PublicKey})[] = [
  {
    ...
    name: 'Fake',
    symbol: 'PCS',
    image: 'https://pump.fun/_next/image?url=%2Flogo.png&w=32&q=75',
    baseWager: 1e9,
    decimals: 9,
    usdPrice: 0,
  },
